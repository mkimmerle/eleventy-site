...
<form name="contact" method="POST" data-netlify="true" id="jform">
	...
	<div class="input-container">
		<label for="phone">
			<span class="sr-only">Phone (ex: 203-555-1234)</span>
			<input type="tel" name="phone" id="phone" class="text-input" pattern="^\d{3}-\d{3}-\d{4}$" placeholder="Phone (ex: 203-555-1234)" required>
