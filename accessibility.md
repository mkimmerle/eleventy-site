...
<section class="content-container">
	...
	<figure><img src="/art/a11y_audit_tool.jpg" class="blog-image" alt="Dashboard showing 27 new accessibility violations and 1 resolved issue"></figure>
	<p class="u-b1">
...
<form name="accessibility" action="/thanks" method="POST" data-netlify="true" id="jform">
	...
	<div class="input-container">
		<label for="phone">
			<span>Phone (ex: 203-555-1234) (required)</span>
	...
	<div class="input-container">
		<label for="url">
			<span>Website URL (ex: https://www.yoursite.com) (required)</span>
	...
	<div class="input-container">
		<label for="comments">
			...
			<textarea name="comments" id="comments" class="text-input" aria-describedby="comments-error"></textarea>
